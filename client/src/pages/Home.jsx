  ...
  return (
    <section className='max-w-xl mx-auto'>
      <div >
        ...
        text-[10px] max-w-[500px]">Browse through
         a collection of imaginative and visually
      ...
      <div className='mt-10'>
        {loading ? (
          ...
          <div className="grid lg:grid-cols-3 sm:grid-cols-2 xs:grid-cols-1 grid-cols-0 gap-3">
              {searchText ? (
                <RenderCards
                  data={searchResult}
